...
try {
  ...
  switch ($bot) {
    case "Consultar":
      ...
      if($objEvidencia->getEstado() != "Registrada"){
        $isRegisterOnly = true;
      } else {
    ...
    case "Verificar":
      ...
      $objEvidencia = new Evidencia($id, $tit, $auEvi, $cond, $numls, $parag, $fec, $corx, $cory, $obse, "Verificada", $nomEv);
      $objControlEvidencia = new ctrEvidencia($objEvidencia);
...
<body>
    ...
    ?>
       <script>  
        Swal.fire({
            position: 'top-end',
            icon: 'error',
            title: 'La evidencia no se encuentra en estado Registrada',
            showConfirmButton: false,
            timer: 2500
          });
        </script>
  ...
  <main>
    ...
    <div class="d-flex flex-column flex-shrink-0 p-3 bg-light overflow-auto" style="width: 80%; ">
      <h1 class="mb-3">Verificar Evidencias</h1>
      <form name="formEv" action="visEvidenciasEstado.php" method="post">
        ...
        <div class="row">
          <div class="col">
            <div class="row">
              <div class="col">
                <input type="submit" class="btn btn-primary btn-lg btn-search" value="Verificar" name="btn" />
              </div>
              <div class="col">
