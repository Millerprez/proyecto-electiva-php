...
<body>
  ...
  <main>
    ...
    <!-- Modal -->
    <div class="modal modal-dialog modal-dialog-centered" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      ...
      <div class="table-wrapper">
        <div class="table-title">
          <div class="row">
            ...
            <div class="col-sm-7">
              <a href="#" class="btn btn-secondary"><i class="material-icons" data-bs-toggle="modal" data-bs-target="#exampleModal"></i> <span>Nueva evidencia</span></a>
            </div>
          </div>
        </div>
